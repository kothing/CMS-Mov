					...
					<div class="stui-pannel__head active bottom-line clearfix">
						...
						<ul class="nav nav-head">
							<li <?php if ($cs4 == "rankhot") {
									echo 'class="active"';
								} elseif ($cs4 == "rankpoint") {
								} else {
									echo 'class="active"';
								}; ?>><a href="tv_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_<?php echo $cs3 ?>_rankhot_<?php echo $cs5 ?>.html">最近热映</a></li>
							<li <?php if ($cs4 == "rankpoint") {
									echo 'class="active"';
								} else {
								}; ?>><a href="tv_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_<?php echo $cs3 ?>_rankpoint_<?php echo $cs5 ?>.html">最受好评</a></li>
						</ul>
					</div>
				</div>
