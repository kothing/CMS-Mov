...
$mx = 'active';
?>
<title><?php if (!empty($mxq)) {
			echo '《' . $mxq . '》';
		} else {
			echo $mxq;
		} ?>最新电影-最新电视剧-明星个人资料剧情综艺节目-VIP高清影院视频抢先片免费在线观看-<?php echo $mkcms_seoname; ?></title>
					...
					if (!empty($mingxing4)) {
						echo '<div class="stui-pannel-box">
								<div class="stui-content__thumb">
									...
									<img src="' . $mingxing5[0] . '" data-original="' . $mingxing5[0] . '" onerror=src="/template/default/img/load.gif" alt="' . $mingxing6[0] . '" title="' . $mingxing6[0] . '" width="100%"/>
								...
								<div class="stui-content__detail">
									<div class="col-md-1">
										<h1 class="title">
											<a href="' . $mingxing4[0] . '" target="_blank" title="' . $mingxing4[0] . '">' . $mingxing6[0] . '</a>
										</h1>
									</div>
			...
			<div class="col-lg-wide-75 col-xs-1 padding-0">
				<div class="stui-pannel stui-pannel-bg clearfix">
					...
					if (!empty($flid1)) { ?>
						<div class="stui-pannel_hd">
							<div class="stui-pannel__head active bottom-line clearfix">
								<span class="more text-muted pull-right hidden-xs">最近更新<a href="mxstar_<?php echo $mxq; ?>_dy_1.html"><?php if (!empty($mxq)) {
																																			echo '《' . $mxq . '》';
																																		} else {
																																			echo $mxq;
																																		} ?></a>的影片</span>
								<ul class="nav nav-head">
									<li <?php if ($leixing == "dy") {
											echo 'class="active"';
										} ?>><a href="mxstar_<?php echo $flid1; ?>_dy_1.html">电影</a></li>
									<li <?php if ($leixing == "ds") {
											echo 'class="active"';
										} else {
										}; ?>><a href="mxstar_<?php echo $flid1; ?>_ds_1.html">电视剧</a></li>
									<li <?php if ($leixing == "zy") {
											echo 'class="active"';
										} else {
										}; ?>><a href="mxstar_<?php echo $flid1; ?>_zy_1.html">综艺</a></li>
									<li <?php if ($leixing == "dm") {
											echo 'class="active"';
										} else {
										}; ?>><a href="mxstar_<?php echo $flid1; ?>_dm_1.html">动漫</a></li>
								</ul>
							</div>
						</div>
						<div class="stui-pannel_bd">
					...
					<h4 class='title text-overflow'><a href='" . $chuandi . "' title='" . $title . "'>" . $title . "</a></h4>
							...
							<ul class="stui-page text-center cleafix"><?php if (!empty($mingxing)) { ?><?php include('system/mxfenye.php'); ?><?php } else { ?><p style="text-align: center;"><img class="sosoimg" src="template/default/img/blank.png" alt="暂无内容" /></p><?php } ?>
							</ul>
						</div>
					<?php } else {
						echo "";
