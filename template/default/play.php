...
<?php if (strpos($zypic[0], 'iqiyipic.com') !== false) {
...
<script type="text/javascript" src="/template/default/js/mytheme-ui.js"></script>
<style type="text/css">
	#timer {
					...
					<div class="stui-player__detail detail" id="dianshijuid">
						<ul class="more-btn">
							...
							<?php if ($mkcmstyle == 'm') {
								...
								echo '<li><a href="javascript:scroll(0,0)" class="btn btn-default" id="btn-prev" title="上一集"><i class="icon iconfont icon-back hidden-xs"></i> 上一集</a></li><li><a href="javascript:scroll(0,0)" class="btn btn-default" id="btn-next" title="下一集">下一集 <i class="icon iconfont icon-more hidden-xs"></i></a></li>';
							} ?>
						</ul>
						<h1 class="title" id="xuji"><a href="/seacher-<?php echo $timu; ?>.html" title="<?php echo $timu; ?>"><?php echo $timu; ?></a><span class="js"></span></h1>
						<span class="text-muted">地区：</span><?php if ($h == "") {
																$h = $hh;
																echo $h;
															} else {
																echo $h;
						...
						<?php if ($gx == "") {
							...
							echo '<span class="split-line"></span><span class="text-muted">状态：</span>' . $gx;
						} ?>
					</div>
				</div>
				<!-- 播放器-->
				<div class="stui-pannel stui-pannel-bg clearfix">
					<div class="stui-pannel-box b playlist mb">
						...
						if ($cat == $dycat) {
							...
							if (empty($vod)) {
								echo "<li class='dyli'><a>暂无资源</a></li>";
							}
							echo '</ul></div>';
						} else {
							$i = 0;
							...
							if ($cat == $zycat) {
								...
								foreach ($zyvi as $keya => $tvideoa) {
									echo "<li class='zyli active'><a data-num='$noqi[$keya]' href='$tvideoa' class='btn btn-danger btn-play-source 1' title='$noqi[$keya]$zyname[$keya]'><img src='$zypic[$keya]' onerror=src='/template/default/img/load.gif' alt='$zyname[$keya]' width=100%/><br>$noqi[$keya]<br>$zyname[$keya]</a></li>";
								}
								echo '</ul></div>';
							}
						} ?>
				...
				<div class="stui-pannel stui-pannel-bg clearfix">
					<div class="stui-pannel-box clearfix">
						<div class="col-pd text-center" style="border: 1px solid #eee; border-radius: 5px;">
							<p style="padding: 30px; margin: 0;"><img src="<?php echo $mkcms_appbt; ?>"></p>
							<p><?php echo $mkcms_apppic; ?></p>
						</div>
					</div>
				</div><!-- 扫码-->
				<div class="stui-pannel stui-pannel-bg clearfix">
