							...
							<div class="table-responsive">
								<form method="get" class="form-inline">
									<div class="fl">
										...
										<a class="btn btn-info" href="cms_dao.php<?php if (isset($_GET['id'])) {
																						echo '?cpass=' . $_GET["id"];
																					} ?>"><span class="icon-plus-square">导出</span></a>
									</div>
										...
										<tbody>
											...
											?>
												<tr>
													...
													<td><?php if ($row['c_usetime'] > 0) {
															echo date('Y-m-d H:i:s', $row['c_usetime']);
														} else {
															echo "未使用";
														} ?></td>
													<td><?php
