					...
					<div class="stui-pannel-box">
						...
						<div class="stui-pannel_hd">
							<div class="stui-pannel__head active bottom-line clearfix">
								...
								<h3 class="title">
									...
									</svg><span style="color: #FF00FF;">全网影视：</span>搜索到与《<a href="/seacher-<?php echo $q ?>.html" title="<?php echo $q ?>"><?php echo $q ?></a>》相关的影片
								</h3>
							</div>
						</div>
						<div class="stui-pannel_bd">
							...
							?>
									<li class="activeclearfix" <?php echo $xianshi ?>>
										...
										<div class="detail">
											...
											<div class="m-description"><?php echo $jianjie ?></div>
											</p>
									...
									<li class="col-md-5 col-sm-4 col-xs-3">
										<div class='stui-vodlist__box stui-vodlist__bg'>
											<a class="v-thumb stui-vodlist__thumb lazyload" href="<?php echo $chuandi ?>" title="<?php echo $title ?>" <?php echo $ok; ?> data-original="<?php echo $tupian ?>">
												...
												<?php if (!($fenshu1 == "")) {
													echo '<span class="pic-tag pic-tag-h">' . $fenshu1 . '</span>';
												} ?>
							...
							<?php }
								...
								echo '<p style="text-align: center;"><img class="sosoimg" src="/template/default/img/blank.png" alt="暂无内容"/></p>';
							} ?>
							<div class="stui-pannel_hd">
								<div class="stui-pannel__head active bottom-line clearfix">
									<span class="more text-muted pull-right hidden-xs"></span>
									<h3 class="title"><svg class="iconm" aria-hidden="true">
											<use xlink:href="#icon-list"></use>
										</svg><span style="color: #FF00FF;">抢先资源：</span>搜索到与《<a href="/seacher-<?php echo $q ?>.html" title="<?php echo $q ?>"><?php echo $q ?></a>》相关的影片
									</h3>
								</div>
							</div>
							<div class="stui-pannel_hd">
										...
										if (!($data['data'][$i]['vod_cid'] == 16)) {
											...
											<li class="activeclearfix" <?php echo $xianshi ?>>
												...
												<div class="detail">
													...
													<p class="margin-0 hidden-smss hidden-xss">
													<div class="m-description"><span class="text-muted">简介：</span><?php echo $data["data"][$i]["vod_content"]; ?></div>
													</p>
													<p class="margin-0 hidden-smss hidden-xss"><a <?php echo $ok; ?> class="text-muted" href="<?php echo $ccb; ?>" title="<?php echo $data["data"][$i]["vod_name"]; ?>">查看详情</a></p>
												</div>
											</li>
									<?php }
									} ?>
									<?php $cxsearch = $data["data"][0]["vod_name"];
									if (empty($cxsearch) || $data['data'][$i]['vod_cid'] == 16) { ?> <p style="text-align: center;"><img class="sosoimg" src="/template/default/img/blank.png" alt="暂无内容" /></p><?php } ?>
								</ul>
							</div>
						</div>
					</div>
