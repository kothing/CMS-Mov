...
$szz = '#Welcome，免费观看<span>(.*?)</span>部热门大片#';
						...
						<div class="bk-border-danger bk-bg-white bk-fg-danger bk-ltr bk-padding-15">
							<div class="row">
								...
								<div class="col-xs-8 text-center bk-vcenter">
									...
									<h4 class="bk-margin-off">
										<?php $sql = "SELECT COUNT(*) AS count FROM mkcms_user";
						...
						<div class="bk-border-success bk-bg-white bk-fg-success bk-ltr bk-padding-15">
							<div class="row">
								...
								<div class="col-xs-8 text-center bk-vcenter">
									...
									<h4 class="bk-margin-off">
										<?php $sql = "SELECT COUNT(*) AS count FROM mkcms_vod";
										$result = mysqli_fetch_array(mysqli_query($conn, $sql));
										$count = $result['count'];
										echo $count; ?>
									</h4>
						...
						<div class="bk-border-warning bk-bg-white bk-fg-warning bk-ltr bk-padding-15">
							<div class="row">
								...
								<div class="col-xs-8 text-center bk-vcenter">
									...
									<h4 class="bk-margin-off">
										<?php $sql = "SELECT COUNT(*) AS count FROM mkcms_user_pay";
										$result = mysqli_fetch_array(mysqli_query($conn, $sql));
										$count = $result['count'];
										echo $count; ?>
									</h4>
						...
						<div class="list-group">
							...
							<a href="#" class="list-group-item">
								<div class="row">
									...
									<div class="col-xs-6 text-right">
										<span class="label label-success bk-noradius"><?php if (function_exists('curl_init')) {
																							echo '支持';
																						} else {
																							echo '不支持';
																						} ?>
