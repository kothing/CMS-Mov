...
?>
<?php include('../template/' . $mkcms_template . '/head.php');
?>
...
<body>
  <?php include('../template/' . $mkcms_template . '/header.php'); ?>
              ...
              <div class="coin-block clearfix">
                ...
                <div class="coin-btn">
                  <?php if ($row['u_group'] > 1) {
                    echo "<a  class='mll btn btn-default'>到期时间：";
                    echo date('Y-m-d', $row['u_end']);
                    echo "</a>";
                  }; ?>
                </div>
              </div>
                ...
                <div id="myTabContent" class="tab-content">
                  ...
                  <div class="tab-pane fadee active" id="inflow">
                    ...
                    <nav class="text-center">
                      <div class="pagination text-center"><?php echo page_shows($pager[2], $pager[3], $pager[4], 2); ?></div>
                    </nav>
                  </div>
  ...
  <?php include('../template/' . $mkcms_template . '/footer.php'); ?>
</body>
