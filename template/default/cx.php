			...
			<div class="stui-pannel stui-pannel-bg clearfix">
				<div class="stui-pannel-box">
					...
					<ul class="stui-screen__list type-slide bottom-line-dot clearfix up-ul1">
						...
						?>
																		<li>
																			<a href="/cx_<?php echo $list['list'][$i]['list_id']; ?>_1.html">
																				<?php echo $list['list'][$i]['list_name']; ?>
																			</a>
																		</li>
						<?php }
																}
																			...
																			<div class='stui-vodlist__box stui-vodlist__bg'>
																				...
																				<div class='stui-vodlist__detail active'>
																					<h4 class='title text-overflow'>
																						<a href='<?php echo $ccb; ?>' title='<?php echo $data['data'][$i]['vod_name']; ?>'><?php echo $data['data'][$i]['vod_name']; ?>
																						</a>
																					</h4>
