...
$bdinfo = '#">(.*?)</span>\s*<a title="(.*?)" href="(.*?)" class="name" monitor-shortpv-c="(.*?)" monitor-pos="(.*?)">(.*?)</a>[\s\S]+?<span class="vv">(.*?)</span>#';
