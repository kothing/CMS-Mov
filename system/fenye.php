<?php
if ($leixing == "dongman") {
    $fenyeurl = "http://www.360kan.com/" . $leixing . "/list.php?cat=" . $cat . "&year=" . $year . "&area=" . $area . "&rank=" . $rank . "&pageno=" . $pageno;
} else if ($leixing == "zongyi") {
    $fenyeurl = "http://www.360kan.com/" . $leixing . "/list.php?cat=" . $cat . "&act=" . $act . "&area=" . $area . "&rank=" . $rank . "&pageno=" . $pageno;
} else {
    $fenyeurl = "http://www.360kan.com/" . $leixing . "/list.php?cat=" . $cat . "&year=" . $year . "&area=" . $area . "&act=" . $act . "&rank=" . $rank . "&pageno=" . $pageno;
}
