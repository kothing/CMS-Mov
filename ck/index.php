...
<body>
    ...
    <script>
        ...
        var playlink = "",
            urlpar = 'DiandianTV';
        var dmapi = 'https://danmu.izhuolin.cn/3.0/',
            vodurl = '<?php echo $_GET['url']; ?>',
            vodid = "",
            vodsid = "",
            vodpic = "./img/H222eb1400c714319a40e62c742cc834bv.jpg",
            vodname = "",
            next = "";
        var pic = "./img/H222eb1400c714319a40e62c742cc834bv.jpg";
        var playnext = "https://mk99.net/" + next;
        var user = '',
            group = "",
            color = '#00a1d6',
            logo = '',
