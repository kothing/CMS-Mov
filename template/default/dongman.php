			...
			<div class="stui-pannel stui-pannel-bg clearfix">
				<div class="stui-pannel-box">
					...
					<ul class="stui-screen__list type-slide bottom-line-dot clearfix up-ul1">
						...
						<li><a href="dongman_all_<?php echo $cs1 ?>_<?php echo $cs2 ?>_<?php echo $cs3 ?>_<?php echo $cs4 ?>.html">全部</a></li>
						</li>
				...
				<div class="stui-pannel_hd">
					<div class="stui-pannel__head active bottom-line clearfix">
						...
						<ul class="nav nav-head">
							<li <?php if ($cs3 == "rankhot") {
									echo 'class="active"';
								} elseif ($cs3 == "createtime") {
								} else {
									echo 'class="active"';
								}; ?>><a href="dongman_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_rankhot_<?php echo $cs4 ?>.html">最近热映</a></li>
							<li <?php if ($cs3 == "createtime") {
									echo 'class="active"';
								} else {
								}; ?>><a href="dongman_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_createtime_<?php echo $cs4 ?>.html">最新上映</a></li>
						</ul>
					</div>
				</div>
