...
function loadPage(e) {
  ...
  $.ajax({
    ...
    error: function (e, n, r) {
      t.html(
        '<h4 style="margin-top:90px;"><i class="fa fa-warning"></i> Error 404! Page not found.</h4>'
      );
    },
    async: !1,
  });
    ...
    if (retina()) {
      ...
      if (jQuery.browser.mozilla)
        if (!navigator.userAgent.match(/Trident\/7\./)) {
          $(".boxchart")
            .css("MozTransform", "scale(0.5,0.5)")
            .css("height", "30px;");
          $(".boxchart")
            .css("height", "30px;")
            .css("margin", "-15px 15px -15px -5px");
        } else {
          $(".boxchart").css("zoom", 0.5);
          $(".boxchart")
            .css("height", "30px;")
            .css("margin", "0px 15px -15px 17px");
        }
...
$(document).ready(function (e) {
  ...
  e(".nav-sidebar a").click(function (t) {
    ...
    if (e(this).parent().find("ul").size() != 0) {
      ...
      e(this).parent().parent().parent().hasClass("opened") ||
        e(".nav a")
          .not(this)
          .parent()
          .find("ul")
