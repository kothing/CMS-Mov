				...
				<div class="stui-pannel-box">
					...
					<ul class="stui-screen__list type-slide clearfix up-ul4">
						...
						<?php if ($cs2 == "other" || $cs2 == "其他") { ?>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_黄渤_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>黄渤</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_孙红雷_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>孙红雷</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_郑伊健_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>郑伊健</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_吴君如_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>吴君如</a></li>
						<?php } ?>
						<?php if ($cs2 == 22 || $cs2 == "印度") { ?>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_阿米尔·汗_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>阿米尔·汗</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_伊尔凡·可汗_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>伊尔凡·可汗</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_艾西瓦娅·雷_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>艾西瓦娅·雷</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_桑杰·达特_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>桑杰·达特</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_迪皮卡·帕度柯妮_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>迪皮卡·帕度柯妮</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_阿贾耶·德乌干_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>阿贾耶·德乌干</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_阿克谢·库玛尔_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>阿克谢·库玛尔</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_拉妮·玛克赫吉_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>拉妮·玛克赫吉</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_赛义夫·阿里·汗_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>赛义夫·阿里·汗</a></li>
						<?php } ?>
						...
						<?php if ($cs2 == 18 || $cs2 == "台湾") { ?>
							...
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_陈柏霖_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>陈柏霖</a></li>
							<li><a href='movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_彭于晏_<?php echo $cs4 ?>_<?php echo $cs5 ?>.html'>彭于晏</a></li>
				...
				<div class="stui-pannel_hd">
					<div class="stui-pannel__head active bottom-line clearfix">
						...
						<ul class="nav nav-head">
							<li<?php if ($cs4 == "rankhot") {
									echo ' class="active"';
								} ?>><a href="movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_<?php echo $cs3 ?>_rankhot_<?php echo $cs5 ?>.html">按最热</a></li>
								<li<?php if ($cs4 == "createtime") {
										echo ' class="active"';
									} else {
									}; ?>><a href="movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_<?php echo $cs3 ?>_createtime_<?php echo $cs5 ?>.html">按最新</a></li>
									<li<?php if ($cs4 == "rankpoint") {
											echo ' class="active"';
										} ?>><a href="movie_<?php echo $cs0 ?>_<?php echo $cs1 ?>_<?php echo $cs2 ?>_<?php echo $cs3 ?>_rankpoint_<?php echo $cs5 ?>.html">按好评</a></li>
						</ul>
					</div>
				</div>
					...
					<ul class="stui-vodlist clearfix">
						...
						foreach ($xname as $key => $xvau) {
							...
							if ($i < 28) {
								...
								if (!empty($xfufei[$key])) {
									echo "<span class='pic-tag pic-tag-h'>" . $lname[$key] . "</span>";
								}
